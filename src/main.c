...
START_TEST(s21_asin_test) {
  ...
  ck_assert_ldouble_eq_tol(asin(0.9), s21_asin(0.9), S21_EPS_T);
...
START_TEST(s21_ceil_test) {
  ...
  ck_assert_ldouble_eq_tol(ceil(1.9), s21_ceil(1.9), S21_EPS_T);
  ck_assert_ldouble_eq_tol(ceil(0.9), s21_ceil(0.9), S21_EPS_T);
  ck_assert_ldouble_eq_tol(ceil(-1.0), s21_ceil(-1.0), S21_EPS_T);
  ck_assert_ldouble_eq_tol(ceil(-1.9), s21_ceil(-1.9), S21_EPS_T);
  ck_assert_ldouble_eq_tol(ceil(-0.9), s21_ceil(-0.9), S21_EPS_T);
...
START_TEST(s21_floor_test) {
  ...
  ck_assert_ldouble_eq_tol(floor(1.9), s21_floor(1.9), S21_EPS_T);
  ck_assert_ldouble_eq_tol(floor(0.9), s21_floor(0.9), S21_EPS_T);
  ck_assert_ldouble_eq_tol(floor(-1.0), s21_floor(-1.0), S21_EPS_T);
  ck_assert_ldouble_eq_tol(floor(-1.9), s21_floor(-1.9), S21_EPS_T);
  ck_assert_ldouble_eq_tol(floor(-0.9), s21_floor(-0.9), S21_EPS_T);
...
START_TEST(s21_sin_test) {
  ...
  // ck_assert_ldouble_eq_tol(sin(DBL_MAX), s21_sin(DBL_MAX), S21_EPS_T);
